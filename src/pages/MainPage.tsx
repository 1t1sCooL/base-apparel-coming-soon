                    ...
                    <div className={styles.description}>
                        ...
                        <div className={styles.inputWrapper}>
                            <div className={styles.svg}>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 12 20"><path fill="none" stroke="#FFF" stroke-width="2" d="M1 1l8.836 8.836L1 18.671"/>
                                </svg>
                            </div>
